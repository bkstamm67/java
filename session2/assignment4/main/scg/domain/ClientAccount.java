...
public final class ClientAccount implements Account, Comparable<ClientAccount>{
	...
	*/
	...
	public int compareTo(ClientAccount other) {
		...
		answer = name.compareTo(other.getName());
		if(answer == 0) {
			String thisPersonalName = contact.toString();
			String otherPersonalName = other.getContact().toString();
			answer = thisPersonalName.compareTo(otherPersonalName);
			if(answer == 0) {
				String thisAddress = address.toString();
				String otherAddress = other.getAddress().toString();
				answer = thisAddress.compareTo(otherAddress);
			}
		}
		*/
