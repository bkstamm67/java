...
public class TimeCardTests {
	...
	*/
	...
	public void initialize() {
		...
		testAddress = new Address("600 N Park St", "Madison", StateCode.WA, "53706");
		testAccount = new ClientAccount("Name of the Wind", testClientAccountName, testAddress);
		billableHours = 15;
		nonBillableHours = 23;
