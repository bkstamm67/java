...
public final class Assignment06Test {
    ...
    private class TestPropertyListener implements PropertyChangeListener, VetoableChangeListener {
        /** The last event. */
    ...
    private class TestBenefitListener implements BenefitListener {
    ...
    public void testBenefits() {
        ...
        hrServer.enrollDental(consultantList.get(MEDICAL_CANCEL));
        hrServer.cancelMedical(consultantList.get(DENTAL_ENROLLEE));
        ...
        assertEquals(consultantList.get(MEDICAL_CANCEL),testBenefitListener.dentalEnrollConsultant);
        assertEquals(consultantList.get(DENTAL_ENROLLEE),testBenefitListener.medicalCancelConsultant);
