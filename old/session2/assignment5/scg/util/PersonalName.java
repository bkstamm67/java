...
public class PersonalName implements Comparable<PersonalName>, Serializable{
	...
	private static final long serialVersionUID = 6919460548144244790L;
	...
	public int compareTo(PersonalName other) {
		...
		if(this == other) return answer;
			...
			answer = lastName.compareTo(other.getLastName());
			if(answer == 0) {
				answer = firstName.compareTo(other.getFirstName());
				if(answer == 0) {
					answer = middleName.compareTo(middleName);
				}
			}
		}
		return answer;
